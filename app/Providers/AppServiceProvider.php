...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(
            'App\Services\Specification\SpecificationServiceInterface',
            'App\Services\Specification\SpecificationService'
        );
        $this->app->bind(
        ...
        $this->app->bind(
            'App\Services\Comment\CommentServiceInterface',
            'App\Services\Comment\CommentService'
        );
        $this->app->bind(
